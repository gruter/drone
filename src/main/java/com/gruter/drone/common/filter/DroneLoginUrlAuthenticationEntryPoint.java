...
public class DroneLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
   

	private static final Logger logger = LoggerFactory.getLogger(DroneLoginUrlAuthenticationEntryPoint.class);
